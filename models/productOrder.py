...
class ProductOrder(db.Model):
    ...
    product_id = db.mapped_column(db.ForeignKey("Products.id", ondelete="CASCADE"), primary_key=True)
    order_id = db.mapped_column(db.ForeignKey("Orders.id", ondelete="CASCADE"), primary_key=True)
